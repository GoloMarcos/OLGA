...
def train(args,logger,data,model,path):
    ...
    for epoch in range(args.n_epochs):
        ...
        auc,ap,f1,acc,precision,recall,val_loss, dic = fixed_graph_evaluate(args,checkpoints_path, model, data_center,data,radius,data['test_mask'])
    ...
    auc,ap,f1,acc,precision,recall,val_loss, dic_metrics = fixed_graph_evaluate(args,checkpoints_path, model, data_center,data,best_radius,data['test_mask'])

    
    return dic_metrics, outputs.cpu().numpy()
